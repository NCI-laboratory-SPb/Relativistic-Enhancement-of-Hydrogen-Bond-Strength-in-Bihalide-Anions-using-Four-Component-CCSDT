4сDCCCSDQTAIM.py
This script performs a four-component electron density calculation on a three-dimensional grid of points. 
The density is derived from a CCSD wave function generated with the Dirac-Coulomb and Lévy-Leblond Hamiltonians, incorporating a Gaussian finite-nucleus model.
Usage:
...
This program computes the translational, vibrational, and rotational components of thermodynamic functions using molecular constants (including 
the nuclear configuration point group, total molecular mass, vibrational frequencies, and rotational constants) together with external parameters (temperature and pressure). 
It supports atomic systems, linear tops, and asymmetric (nonlinear) tops.
Usage:
